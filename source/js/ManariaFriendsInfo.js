...
function animeSeasonSelect(season){
	...
	var section
	if (season == 1){
		section = "ManariaFriendsSeasonOneAnimeData"
	}
	else if(season == 2){
		section = "ManariaFriendsSeasonTwoAnimeData"
	}
	return section
}
...
function charSeasonSelect(season){
	...
	var section
	if (season == 1){
		section = "ManariaFriendsSeasonOneCharacterData"
	}
	else if(season == 2){
		section = "ManariaFriendsSeasonTwoCharacterData"
	}
	return section
}
...
function episodeSeasonSelect(season){
	...
	var section
	if (season == 1){
		section = "ManariaFriendsSeasonOneEpisodeData"
	}
	else if(season == 2){
		section = "ManariaFriendsSeasonTwoEpisodeData"
	}
	return section
}
...
function imageSeasonSelect(season){
	...
	var section
	if (season == 1){
		section = "ManariaFriendsSeasonOneImageData"
	}
	else if(season == 2){
		section = "ManariaFriendsSeasonTwoImageData"
	}
	return section
}
...
function videoSeasonSelect(season){
	...
	var section
	if (season == 1){
		section = "ManariaFriendsSeasonOneVideoData"
	}
	else if(season == 2){
		section = "ManariaFriendsSeasonTwoVideoData"
	}
	return section
}
