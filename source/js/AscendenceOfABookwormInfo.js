...
function animeSeasonSelect(season){
	...
	var section
	if (season == 1){
		section = "AoBSeasonOneAnimeData"
	}
	else if(season == 2){
		section = "AoBSeasonTwoAnimeData"
	}
	return section
}
...
function charSeasonSelect(season){
	...
	var section
	if (season == 1){
		section = "AoBSeasonOneCharacterData"
	}
	else if(season == 2){
		section = "AoBSeasonTwoCharacterData"
	}
	return section
}
...
function episodeSeasonSelect(season){
	...
	var section
	if (season == 1){
		section = "AoBSeasonOneEpisodeData"
	}
	else if(season == 2){
		section = "AoBSeasonTwoEpisodeData"
	}
	return section
}
...
function imageSeasonSelect(season){
	...
	var section
	if (season == 1){
		section = "AoBSeasonOneImageData"
	}
	else if(season == 2){
		section = "AoBSeasonTwoImageData"
	}
	return section
}
...
function videoSeasonSelect(season){
	...
	var section
	if (season == 1){
		section = "AoBSeasonOneVideoData"
	}
	else if(season == 2){
		section = "AoBSeasonTwoVideoData"
	}
	return section
}
