...
function animeSeasonSelect(season){
	...
	var section
	if (season == 1){
		section = "GLTSeasonOneAnimeData"
	}
	else if(season == 2){
		section = "GLTSeasonTwoAnimeData"
	}
	return section
}
...
function charSeasonSelect(season){
	...
	var section
	if (season == 1){
		section = "GLTSeasonOneCharacterData"
	}
	else if(season == 2){
		section = "GLTSeasonTwoCharacterData"
	}
	return section
}
...
function episodeSeasonSelect(season){
	...
	var section
	if (season == 1){
		section = "GLTSeasonOneEpisodeData"
	}
	else if(season == 2){
		section = "GLTSeasonTwoEpisodeData"
	}
	return section
}
...
function imageSeasonSelect(season){
	...
	var section
	if (season == 1){
		section = "GLTSeasonOneImageData"
	}
	else if(season == 2){
		section = "GLTSeasonTwoImageData"
	}
	return section
}
...
function videoSeasonSelect(season){
	...
	var section
	if (season == 1){
		section = "GLTSeasonOneVideoData"
	}
	else if(season == 2){
		section = "GLTSeasonTwoVideoData"
	}
	return section
}
