...
function animeSeasonSelect(season){
	...
	var section
	if (season == 1){
		section = "SteinsGateSeasonOneAnimeData"
	}
	else if(season == 2){
		section = "SteinsGateSeasonTwoAnimeData"
	}
	return section
}
...
function charSeasonSelect(season){
	...
	var section
	if (season == 1){
		section = "SteinsGateSeasonOneCharacterData"
	}
	else if(season == 2){
		section = "SteinsGateSeasonTwoCharacterData"
	}
	return section
}
...
function linkAdder(data){
	...
	for (i in characterElement){
		...
		console.log(characterElement[i])
...
function episodeSeasonSelect(season){
	...
	var section
	if (season == 1){
		section = "SteinsGateSeasonOneEpisodeData"
	}
	else if(season == 2){
		section = "SteinsGateSeasonTwoEpisodeData"
	}
	return section
}
...
function imageSeasonSelect(season){
	...
	var section
	if (season == 1){
		section = "SteinsGateSeasonOneImageData"
	}
	else if(season == 2){
		section = "SteinsGateSeasonTwoImageData"
	}
	return section
}
...
function videoSeasonSelect(season){
	...
	var section
	if (season == 1){
		section = "SteinsGateSeasonOneVideoData"
	}
	else if(season == 2){
		section = "SteinsGateSeasonTwoVideoData"
	}
	return section
}
