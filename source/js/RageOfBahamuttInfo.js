...
function animeSeasonSelect(season){
	...
	var section
	if (season == 1){
		section = "RageBahamuttSeasonOneAnimeData"
	}
	else if(season == 2){
		section = "RageBahamuttSeasonTwoAnimeData"
	}
	return section
}
...
function charSeasonSelect(season){
	...
	var section
	if (season == 1){
		section = "RageBahamuttSeasonOneCharacterData"
	}
	else if(season == 2){
		section = "RageBahamuttSeasonTwoCharacterData"
	}
	return section
}
...
function episodeSeasonSelect(season){
	...
	var section
	if (season == 1){
		section = "RageBahamuttSeasonOneEpisodeData"
	}
	else if(season == 2){
		section = "RageBahamuttSeasonTwoEpisodeData"
	}
	return section
}
...
function imageSeasonSelect(season){
	...
	var section
	if (season == 1){
		section = "RageBahamuttSeasonOneImageData"
	}
	else if(season == 2){
		section = "RageBahamuttSeasonTwoImageData"
	}
	return section
}
...
function videoSeasonSelect(season){
	...
	var section
	if (season == 1){
		section = "RageBahamuttSeasonOneVideoData"
	}
	else if(season == 2){
		section = "RageBahamuttSeasonTwoVideoData"
	}
	return section
}
