...
function animeSeasonSelect(season){
	...
	var section
	if (season == 1){
		section = "HxHSeasonOneAnimeData"
	}
	else if(season == 2){
		section = "HxHSeasonTwoAnimeData"
	}
	return section
}
...
function charSeasonSelect(season){
	...
	var section
	if (season == 1){
		section = "HxHSeasonOneCharacterData"
	}
	else if(season == 2){
		section = "HxHSeasonTwoCharacterData"
	}
	return section
}
...
function episodeSeasonSelect(season){
	...
	var section
	if (season == 1){
		section = "HxHSeasonOneEpisodeData"
	}
	else if(season == 2){
		section = "HxHSeasonTwoEpisodeData"
	}
	return section
}
...
function imageSeasonSelect(season){
	...
	var section
	if (season == 1){
		section = "HxHSeasonOneImageData"
	}
	else if(season == 2){
		section = "HxHSeasonTwoImageData"
	}
	return section
}
...
function videoSeasonSelect(season){
	...
	var section
	if (season == 1){
		section = "HxHSeasonOneVideoData"
	}
	else if(season == 2){
		section = "HxHSeasonTwoVideoData"
	}
	return section
}
